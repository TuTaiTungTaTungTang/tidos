...
const images = [
  ...
  // Right
  { position: [2.7, 0, 3], rotation: [0, -Math.PI / 2.5, 0], url: 'img/5.jpg', title: 'Child Drawing', description: 'A child crouched and drawing, surrounded by colorful scribbles—expressive and delicate.' },
  { position: [2.5, 0, 5.7], rotation: [0, -Math.PI / 2.5, 0], url: 'img/6.jpg', title: 'ColorfulPark', description: 'An impressionistic park path with vivid leaves and reflective wet pavement.' }
]
